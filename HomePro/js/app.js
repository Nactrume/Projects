(() => {
    ...
    function buildBlogItem(item) {
        ...
        blogItemTemplate += `<a href="${item.url}" class="item-blog__title title--h4">\n\t ${item.title}\n\t </a>`;
        item.text ? blogItemTemplate += `<div class="item-blog__text">${item.text}</div>` : null;
        if (item.tags) {
