(() => {
    ...
    (() => {
        ...
        document.addEventListener("click", (function(e) {
            ...
            if (targetElement.closest(".checkbox ") && targetElement.closest(".filter__block") && targetElement.tagName !== "INPUT") filterBlockShow(targetElement);
            if (targetElement.closest(".filter__clear")) {
                const clearButton = targetElement.closest(".filter__clear");
                filterBlockClear(clearButton);
            }
        }));
        function filterBlockShow(targetElement) {
        ...
        function filterBlockClear(clearButton) {
            ...
            const checkedElements = filterBlock.querySelectorAll(".checkbox__input:checked");
            checkedElements.forEach((checkedElements => {
                checkedElements.checked = false;
            }));
        ...
        for (let i = 0; i < menuLenght; i++) if (menuItem[i].href === currentLocation) menuItem[i].className = "menu__link\t_active";
        window["FLS"] = true;
        isWebp();
        addLoadedClass();
        menuInit();
